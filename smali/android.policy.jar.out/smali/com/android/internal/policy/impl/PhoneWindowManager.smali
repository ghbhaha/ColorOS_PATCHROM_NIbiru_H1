...
.field private mHasDoneSettupWized:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasDoneSettupWized:Z
...
.method updateSystemUiVisibilityLw()I
    ...
    invoke-virtual {v6}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;->isShowingAndNotHidden()Z
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-boolean v10, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomePressed:Z
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenshotChordEnabled:Z
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTriggered:Z

    if-eqz v7, :cond_1

    move-object/from16 v0, p0

    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyTriggered:Z
    ...
    iget-wide v9, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTime:J
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyConsumedByScreenshotChord:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyConsumedByScreenshotChord:Z
    ...
    .local v16, am:Landroid/app/ActivityManager;
    const/4 v7, 0x1
    ...
    .local v39, runningTaskInfos:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    ...
    const-string v9, "com.jrdcom.mmitest.ExecuteTest"
    ...
    const-string v9, "now the top activity is com.jrdcom.mmitest.ExecuteTest, so give it the key."
    ...
    .local v30, homeWasLongPressed:Z
    const/4 v7, 0x0

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomePressed:Z

    const/4 v7, 0x0

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeLongPressed:Z
    ...
    invoke-interface/range {v42 .. v42}, Lcom/android/internal/statusbar/IStatusBarService;->cancelPreloadRecentApps()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v32           #incomingRinging:Z
    :goto_4
    const-wide/16 v9, -0x1
    ...
    const-string v9, "RemoteException when showing recent apps"
    ...
    iput-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;

    goto :goto_2

    .end local v24           #e:Landroid/os/RemoteException;
    .restart local v32       #incomingRinging:Z
    :catch_1
    move-exception v26
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAppLaunchTimeEnabled:Z

    if-eqz v7, :cond_9

    const-string v7, "WindowManager"

    const-string v9, "[AppLaunch] Home key pressed"
    ...
    .end local v30           #homeWasLongPressed:Z
    :cond_b
    if-eqz p1, :cond_d
    ...
    :cond_e
    sget-object v7, Lcom/android/internal/policy/impl/PhoneWindowManager;->WINDOW_TYPES_WHERE_HOME_DOESNT_WORK:[I
    ...
    invoke-interface/range {v42 .. v42}, Lcom/android/internal/statusbar/IStatusBarService;->preloadRecentApps()V
    :try_end_2
    ...
    const-string v9, "RemoteException when preloading recent apps"
    ...
    .end local v16           #am:Landroid/app/ActivityManager;
    .end local v17           #attrs:Landroid/view/WindowManager$LayoutParams;
    .end local v39           #runningTaskInfos:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    :cond_14
    const/16 v7, 0xe2
    ...
    .restart local v16       #am:Landroid/app/ActivityManager;
    const/4 v7, 0x1
    ...
    .restart local v39       #runningTaskInfos:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    invoke-interface/range {v39 .. v39}, Ljava/util/List;->size()I
    ...
    const-string v9, "----------It\'s a temporary plan, please modify with formal version.-----------"
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRecentAppPressed:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRecentAppPressed:Z
    ...
    .restart local v43       #telephonyService:Lcom/android/internal/telephony/ITelephony;
    if-eqz v43, :cond_17
    ...
    const-string v9, "Ignoring RECENTAPP; there\'s a ringing incoming call."
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasDoneSettupWized:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasDoneSettupWized:Z

    .end local v37           #provisioned:I
    :cond_19
    move-object/from16 v0, p0
    ...
    const-string v9, "com.jrdcom.menukey.hints"
    ...
    const-string v7, "com.jrdcom.menukey.hints"

    const-string v9, "com.jrdcom.menukey.hints.RecentAppsActivity"

    invoke-virtual {v8, v7, v9}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStatusBarService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    .local v25, e1:Landroid/os/RemoteException;
    ...
    .end local v25           #e1:Landroid/os/RemoteException;
    .restart local v37       #provisioned:I
    :cond_1a
    const/4 v7, 0x0
    ...
    .end local v37           #provisioned:I
    .restart local v27       #firstbootflag:I
    :cond_1b
    :try_start_6
    move-object/from16 v0, p0
    ...
    iput-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mInputManager:Landroid/hardware/input/InputManager;
    ...
    iget-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mInputManager:Landroid/hardware/input/InputManager;

    const/4 v9, 0x0

    invoke-virtual {v7, v3, v9}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    .local v6, keyUp:Landroid/view/KeyEvent;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v7, v6, v9}, Landroid/hardware/input/InputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z

    goto :goto_d

    .end local v3           #keyDown:Landroid/view/KeyEvent;
    .end local v4           #now:J
    .end local v6           #keyUp:Landroid/view/KeyEvent;
    .end local v16           #am:Landroid/app/ActivityManager;
    .end local v17           #attrs:Landroid/view/WindowManager$LayoutParams;
    .end local v39           #runningTaskInfos:Ljava/util/List;,"Ljava/util/List<Landroid/app/ActivityManager$RunningTaskInfo;>;"
    :cond_23
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEnableShiftMenuBugReports:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSearchKeyShortcutPending:Z

    const/4 v7, 0x0

    move-object/from16 v0, p0

    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mConsumeSearchKeyUp:Z
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mConsumeSearchKeyUp:Z
    ...
    invoke-virtual {v0, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->showOrHideRecentAppsDialog(I)V
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAssistKeyLongPressed:Z
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAssistKeyLongPressed:Z
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSearchKeyShortcutPending:Z
    ...
    iget-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShortcutManager:Lcom/android/internal/policy/impl/ShortcutManager;
    ...
    invoke-virtual {v7, v0, v1, v2}, Lcom/android/internal/policy/impl/ShortcutManager;->getIntent(Landroid/view/KeyCharacterMap;II)Landroid/content/Intent;
    ...
    const-string v10, "Dropping shortcut key combination because the activity to which it is registered was not found: SEARCH+"
    ...
    const-string v10, "Dropping unregistered shortcut key combination: SEARCH+"
    ...
    invoke-virtual {v7, v0, v1, v9}, Lcom/android/internal/policy/impl/ShortcutManager;->getIntent(Landroid/view/KeyCharacterMap;II)Landroid/content/Intent;
    ...
    const-string v10, "Dropping shortcut key combination because the activity to which it is registered was not found: META+"
    ...
    sget-object v7, Lcom/android/internal/policy/impl/PhoneWindowManager;->sApplicationLaunchKeyCategories:Landroid/util/SparseArray;
    ...
    invoke-static {v7, v0}, Landroid/content/Intent;->makeMainSelectorActivity(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRecentAppsDialogHeldModifiers:I
    ...
    iput v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRecentAppsDialogHeldModifiers:I
    ...
    iget-object v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWindowManagerFuncs:Landroid/view/WindowManagerPolicy$WindowManagerFuncs;
    ...
    invoke-interface {v7, v9, v0}, Landroid/view/WindowManagerPolicy$WindowManagerFuncs;->switchKeyboardLayout(II)V
    ...
    iget-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLanguageSwitchKeyPressed:Z
    ...
    iput-boolean v7, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLanguageSwitchKeyPressed:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;->isAlarmUnlockScreen()Z
    ...
    const-string v19, " mVolumeDownKeyTriggered ="
    ...
    const-string v19, " mVolumeUpKeyTriggered ="
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/policy/impl/keyguard/OppoKeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(I)V
    ...
    const-string v17, "persist.sys.anr_sys_key"
    ...
    invoke-interface {v4}, Landroid/media/IAudioService;->isBluetoothScoOn()Z
    ...
    .restart local v4       #audioService:Landroid/media/IAudioService;
    :cond_1c
    const/16 v17, 0x0
